...
from natKit.client.gui.pyqt6.widget import StimulusBuilder
...
class Block(QtWidgets.QWidget):
    def __init__(
        ...
        self.stimuli = [stimulus.build() for stimulus in stimuli]
...
class BlockBuilder:
    ...
    def set_trigger(self, trigger: Trigger) -> BlockBuilder:
        self.trigger = trigger
        return self

    def add_stimulus(
        self, stimulus: StimulusBuilder, repetitions: int = 1
    ) -> BlockBuilder:
