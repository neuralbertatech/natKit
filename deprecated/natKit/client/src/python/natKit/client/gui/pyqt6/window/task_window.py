...
class TaskWindowBuilder:
    ...
    def set_intro_prompt(self, prompt: str) -> TaskWindowBuilder:
        self.intro_prompt = prompt
        return self

    def set_trial_prompt(self, prompt: str) -> TaskWindowBuilder:
        self.trial_prompt = prompt
        return self

    def set_training_stimulus(self, stimuli: List[Stimulus]) -> TaskWindowBuilder:
        self.training_stimuli = stimuli
        return self

    def set_trial_stimulus(self, stimuli: List[Stimulus]) -> TaskWindowBuilder:
        self.trial_stimuli = stimuli
        return self

    def set_triggers(self, triggers: List[Trigger]) -> TaskWindowBuilder:
        self.triggers = triggers
        return self

    def set_number_of_trials(self, trials: int) -> TaskWindowBuilder:
        self.number_of_trials = trials
        return self

    def set_number_of_blocks(self, blocks: int) -> TaskWindowBuilder:
        self.number_of_blocks = blocks
        return self

    def set_inter_trial_interval(self, interval: float) -> TaskWindowBuilder:
        self.inter_trial_interval = interval
        return self

    def set_inter_block_interval(self, interval: float) -> TaskWindowBuilder:
