...
from natKit.client.gui.pyqt6.widget import Stage, StageBuilder
...
from .imu_tutorial_stage import ImuTutorialStage
...
class SetupTaskWidget(Task):
    ...
    def __init__(self, kafka_manager: KafkaManager, *args, **kwargs):
        ...
        self.tutorial_stage = StageBuilder().set_name("Tutorial Stage").set_prompt("This is the tutorial").build()
    ...
    def setup(self):
        ...
        self._next_task_button.clicked.connect(lambda: self.start_tutorial())
        button_layout.addWidget(
    ...
    def start_tutorial(self):
        self.layout = QVBoxLayout()
        self.layout.addWidget(self.tutorial_stage)
        self.setLayout(self.layout)
        self.tutorial_stage.run()
