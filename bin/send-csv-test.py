...
from natKit.api.schemas import CsvSchema
...
def write_data():
    ...
    meta_object = MetaSchema("My CSV Stream", "CsvSchema")
    data_object = CsvSchema("Foo data", "1")
    meta_topic = "meta-124891479184-utf8-MetaSchema"
    data_topic = "data-124891479184-utf8-CsvSchema"
    manager.create_topic(meta_topic)
    manager.create_topic(data_topic)
    meta_messenger = manager.create_messenger(meta_topic)
    data_messenger = manager.create_messenger(data_topic)
